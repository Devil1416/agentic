...
if __name__ == "__main__":
    main()
```
Please note that this code assumes that `config.py`, `pose_extractor.py` and `image_editor.py` are in the same directory as `main.py` (i.e., 'pipeline' directory). If they are located elsewhere, you need to adjust the path accordingly.